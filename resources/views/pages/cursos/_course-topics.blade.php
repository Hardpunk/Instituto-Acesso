            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <div class="faq-description__wrapper">
                        ...
                        <p>Os cursos da Escola de Negócios - ACIC te ensinam por intermédio da EaD (Educação a Distância), com animações e games (do tipo quiz) que estimulam a interatividade e a interação. <br>A Escola de Negócios - ACIC oferece cursos livres, de atualização e qualificação profissional. São destinados a proporcionar ao profissional conhecimentos que permitam o desenvolvimento de novas competências e não exigem escolaridade anterior. <br>O MEC (Ministério da Educação) regulamenta na Lei nº. 9394/96, o Decreto nº. 5.154/04 e a Deliberação CEE 14/97 e seguimos todos os critérios.</p>
                        <h4><br>Vou aprender mesmo?</h4>
                        <p>Os cursos da Escola de Negócios - ACIC são dinâmicos e com várias vantagens comparadas a um curso presencial. Você terá recursos como: <br>Flexibilidade TOTAL de estudo, 24h por dia, sem limite de acesso!</p>
                        <br>
                        <h4>Tem certificado?</h4>
                        <p>Os alunos aprovados receberão o Certificado Digital em seu espaço virtual, após a nota média e prazo mínimo de estudo exigido.<br>Os cursos da Escola de Negócios - ACIC lhe dão a certificação de capacitação profissional, aperfeiçoamento, extensão e concursos públicos.</p>
                    </div>
                </div>
