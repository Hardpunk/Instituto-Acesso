@if (count($trilhas) > 0)
    <section id="treinamentos__wrapper" class="container-lg pb-5 pt-5">
        <h3 class="title d-block text-uppercase text-center mb-5 mb-md-4">TRILHAS DO CONHECIMENTO</h3>
